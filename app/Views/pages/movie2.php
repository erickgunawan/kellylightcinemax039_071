...
<div class="card" style="width: 900px">
  <h5 class="card-title" style="font-size: 30px">SINOPSIS</h5>
  <h2 class="sinopsis">Money Heist yang tayang pertama kali pada 2017 bercerita tentang aksi 'mastermind' yang disebut 'The Professor' (Alvaro Morte) dalam melakukan perampokan terbesar dalam sejarah Spanyol</h2>
</div>
<br>
  <div class="card" style="width: 900px">
    <h5 class="card-title">DETAILS...</h5>
    <h2 class="detail">Cast By :</h2>
  </div>
</div>
</div>
</div>
