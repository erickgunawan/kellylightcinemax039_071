						...
						<tr>
							...
							<td><?= $row['email']; ?></td>
								...
								<div class="btn-group">
									...
									<a href="<?= base_url('/pages/delete/' . $row['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus Data ? <?= $row['username']; ?>?')">Delete<i class="fa fa-trash"></i></a>
							</td>
						</tr>
					<?php endforeach; ?>
				</tbody>
